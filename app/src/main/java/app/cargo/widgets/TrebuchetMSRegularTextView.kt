package com.soberconnect.widgets
...
class TrebuchetMSRegularTextView : AppCompatTextView {
    ...
    override fun setTypeface(tf: Typeface?, style: Int) {
        ...
        if (style == 1) {
            ...
            tf = Typeface.createFromAsset(context.applicationContext.assets, "Trebuchet_MS_Regular.ttf")
        } else {
